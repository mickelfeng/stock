srcdir = /home/huangyongqiang/git/php-src-5.4/ext/stock
builddir = /home/huangyongqiang/git/php-src-5.4/ext/stock
top_srcdir = /home/huangyongqiang/git/php-src-5.4/ext/stock
top_builddir = /home/huangyongqiang/git/php-src-5.4/ext/stock
EGREP = grep -E
SED = /bin/sed
...
RE2C = re2c
AWK = gawk
shared_objects_stock = stock.lo
PHP_PECL_EXTENSION = stock
PHP_MODULES = $(phplibdir)/stock.la
PHP_ZEND_EX =
...
prefix = /usr/local/php
phplibdir = /home/huangyongqiang/git/php-src-5.4/ext/stock/modules
